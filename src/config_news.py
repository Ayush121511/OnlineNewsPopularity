...
# ============================================================
# NOTE: outputs/bert_embeddings.npy is now the Reddit-domain
# embeddings (15,998 x 768) -- news-domain embeddings for the real
# full 3,437-article scrape live under feature_importance/, generated
# by src/feature_importance/embed_news_full.py.

BERT_EMBEDDINGS_PATH = (
    OUTPUTS_DIR / "feature_importance" / "news_full_bert_embeddings.npy"
)

BERT_EMBEDDING_METADATA_PATH = (
    OUTPUTS_DIR / "feature_importance" / "news_full_bert_embedding_metadata.csv"
)
